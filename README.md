...
│   │   ├── development (开发环境)  
│   │   │   ├── nginx (nginx 配置)  
│   │   │   │   └── recommend_tag_engine.conf (框架推荐的 nginx 配置)  
│   │   │   └── supervisor  (supervisor 配置)  
│   │   │       └── recommend_tag_engine_queue_worker.conf (worker 的管理配置)  
│   │   └── production (线上环境)   
│   │       ├── nginx  
│   │       │   └── recommend_tag_engine.conf  
│   │       └── supervisor  
│   │           └── recommend_tag_engine_queue_worker.conf  
│   ├── tool (工具脚本目录)  
