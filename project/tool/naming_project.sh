...
sed_name()
{
    cat $1 | sed -e "s/mini_api_frame/$2/g" > $1.new && mv $1.new $1
}
...
mv $ROOT_DIR/project/config/development/nginx/mini_api_frame.conf $ROOT_DIR/project/config/development/nginx/$1.conf
mv $ROOT_DIR/project/config/development/supervisor/mini_api_frame_queue_worker.conf $ROOT_DIR/project/config/development/supervisor/$1_queue_worker.conf
mv $ROOT_DIR/project/config/production/nginx/mini_api_frame.conf $ROOT_DIR/project/config/production/nginx/$1.conf
mv $ROOT_DIR/project/config/production/supervisor/mini_api_frame_queue_worker.conf $ROOT_DIR/project/config/production/supervisor/$1_queue_worker.conf
